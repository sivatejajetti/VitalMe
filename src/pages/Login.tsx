    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      ...
      >
        ...
        <motion.div
          ...
          className="mt-6 p-4 rounded-xl bg-amber-500/10 border border-amber-500/20 text-left flex gap-3.5"
        >
          <AlertTriangle className="w-5 h-5 text-amber-500 shrink-0 mt-0.5" />
          <div className="space-y-1">
            <h4 className="text-[10px] font-black text-amber-500 uppercase tracking-[0.2em] italic">Google Fit API Notice</h4>
            <p className="text-[11px] leading-relaxed text-muted-foreground font-medium">
              Due to Google's strict verification rules for health/fitness APIs, sensitive scopes (including Heart Rate, Steps, etc.) are restricted. As a result, the app displays an "Unverified App" warning during login/registration and is subject to a maximum limit of 100 total users.
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="flex flex-col items-center gap-1.5 opacity-60">
              ...
              <p className="text-[10px] font-black text-foreground/80 uppercase tracking-[0.2em]">TEJA JETTI</p>
            </div>
          </div>
        </motion.div>
      </motion.div>
